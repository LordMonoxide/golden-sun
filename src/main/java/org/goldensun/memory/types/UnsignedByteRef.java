...
public class UnsignedByteRef implements MemoryRef {
  ...
  public UnsignedByteRef addOverflow(final int val) {
    return this.set(this.get() + val & 0xff);
  }
  ...
  public UnsignedByteRef subOverflow(final int val) {
    return this.set(this.get() - val & 0xff);
  }
  ...
  public UnsignedByteRef incrOverflow() {
  ...
  public UnsignedByteRef decrOverflow() {
