...
public final class GoldenSun_809 {
  ...
  public static void FUN_80908e0() {
    ...
    if(MEMORY.ref(1, r6 + 0x2a02).get() < MEMORY.ref(1, r6 + 0x2a01).get()) {
      //LAB_8090928
      for(r0 = 0; r0 < 0x540; r0++) {
        MEMORY.ref(2, r6 + 0x380 + r0 * 0x2).and(MEMORY.ref(2, r6 + 0x1880 + r0 * 0x2).getUnsigned());
      }
    } else {
      //LAB_8090948
      MEMORY.call(0x3001388, r6 + 0x380, r6 + 0xe00, 0xa80);
      MEMORY.ref(1, r6 + 0x2a01).setu(0);
    }

    //LAB_8090966
    r4 = r6 + 0x2300 + (MEMORY.ref(1, r6 + 0x2a00).getUnsigned() ^ 0x1) * 0x380;
    r1 = r6 + 0x380;

    //LAB_80909a8
    for(r0 = 0; r0 < 0x1c0; r0++) {
    ...
    r2 = MEMORY.ref(1, r6 + 0x2a00).getUnsigned();
    r0 = r6 + r2 * 0x380;
    r6 = r6 + 0x2300 + r2 * 0x380;
    ...
    if(r2 < 0x20) {
      ...
      MEMORY.ref(4, r3 + 0x4).setu(0x5000000);
      MEMORY.ref(4, r3 + 0x8).setu(0x84000070);
      MEMORY.ref(2, 0x2002090).incr();
    }
    ...
    if(r2 < 0x20) {
      r3 = 0x2002094 + r2 * 0xc;
      MEMORY.ref(4, r3).setu(r0 + 0x24c0);
      MEMORY.ref(4, r3 + 0x4).setu(0x5000200);
      MEMORY.ref(4, r3 + 0x8).setu(0x84000070);
      MEMORY.ref(2, 0x2002090).incr();
    }
        ...
        if(!CPU.cpsr().getZero()) { // !=
          ...
          if(!CPU.cpsr().getZero()) { // !=
            ...
            if(!CPU.cpsr().getZero()) { // !=
              ...
              DMA.channels[3].CNT.setu(0x84000000 | r3 * 3 / 0x4);
            }
          }
        }
      } else {
  ...
  public static void FUN_8097194() {
    ...
    CPU.cmpT(r3, 0x0);
    if(CPU.cpsr().getZero()) { // ==
      r2 = MEMORY.ref(4, 0x8097278).get();
      r7 = MEMORY.ref(4, 0x809727c).get();
      r6 = CPU.movT(0, 0x0);
      CPU.r10().value = r2;

      //LAB_80971ee
      do {
        r3 = MEMORY.ref(4, 0x8097280).get();
        r3 = MEMORY.ref(4, r3).get();
        r1 = CPU.movT(0, 0x0);
        r5 = CPU.movT(0, 0x0);
      ...
      //LAB_809721a
      r2 = MEMORY.ref(4, 0x8097284).get();
      r3 = CPU.movT(0, 0x0);
      r2 += CPU.r11().value;
      MEMORY.ref(1, r2).setu(r3);
      r0 = MEMORY.ref(4, 0x8097288).get();
      r0 = FUN_8004278(r0);
      r3 = CPU.r8().value;
      r3 = CPU.addT(r3, 0x46);
      r1 = CPU.movT(0, 0x0);
  ...
  public static void FUN_8097384() {
    ...
    r4 = boardWramMallocHead_3001e50.offset(27 * 0x4).get();
  ...
  public static void FUN_809748c() {
    ...
    r3 = MEMORY.ref(4, 0x80974c8).get();
    r2 = MEMORY.ref(4, 0x80974cc).get();
    r5 = MEMORY.ref(4, r3).get();
    r6 = CPU.addT(r5, r2);
    r0 = CPU.addT(r6, 0x0);
    r1 = CPU.movT(0, 0x2);
    FUN_8091200(r0, r1);
    r3 = MEMORY.ref(4, 0x80974d0).get();
    r5 = CPU.addT(r5, r3);
    r2 = CPU.movT(0, 0x0);
    r3 = MEMORY.ref(2, r5 + r2).get();
    CPU.cmpT(r3, 0x0);
    if(!CPU.cpsr().getZero()) { // !=
      r0 = MEMORY.ref(4, 0x80974d4).get();
      r1 = CPU.movT(0, 0x1);
      FUN_8091200(r0, r1);
    } else {
      //LAB_80974b4
