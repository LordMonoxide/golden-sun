...
public final class MathHelper {
  ...
  public static int decToBcd(int number) {
    int bcd = 0;
  ...
  public static int sign(final int value, final int numberOfBytes) {
    if(numberOfBytes == 4) {
      return value;
    }

    if((value & 1 << numberOfBytes * 8 - 1) != 0) {
      return value | -(1 << numberOfBytes * 8);
    }

    return value;
  }

  public static int unsign(final int value, final int numberOfBytes) {
    return value & (1 << numberOfBytes * 8) - 1;
  }
