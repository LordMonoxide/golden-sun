...
import static org.goldensun.GoldenSun_80b.FUN_80b50c8;
...
public final class GoldenSun_801 {
  ...
  @Method(0x80105d4)
  public static void FUN_80105d4(int r0, int r1, int r2, int r3, final int a4, final int a5) {
    int r4;
    int r5;
    int r6;
    int r7;
  ...
  @Method(0x8011fd8)
  public static int FUN_8011fd8(final int r0, final int r1, final int r2) {
    final Map194 r5 = boardWramMallocHead_3001e50.offset(8 * 0x4).deref(4).cast(Map194::new);

    final int r0_0;
    if(r5 != null) {
      r0_0 = r5.layers_104.get(r0 & 0x3)._2c.get();
    } else {
      r0_0 = 0x2010000;
    }

    //LAB_8011ffe
    return MEMORY.ref(1, 0x202c000 + MEMORY.ref(1, r0_0 + ((r1 >> 16) / 0x10 + (r2 >> 16) / 0x10 * 0x80) * 0x4 + 0x3).getUnsigned() * 0x4).getUnsigned() & 0xf;
  }

  @Method(0x8012038)
  public static int FUN_8012038(int r0, int r1, int r2) {
    int r3;
    int r4;
    final int r5;
    ...
    r3 = r3 << 2;
    r2 = r2 + r3;
    r0 = MEMORY.ref(1, r2 + 0x2).getUnsigned();
    return r0;
  }
  ...
  public static int FUN_801219c(final Vec3 vec) {
    ...
    //LAB_80121c6
    r1 = map.layers_104.get(2)._2c.get();
    r4 = r4 / 0x10;
    r3 = r0 / 0x10 << 7;
    r3 = r4 + r3;
    r3 = r3 << 2;
    r1 = r1 + r3;
    r3 = MEMORY.ref(1, r1 + 0x2).getUnsigned() ^ 0xff;
    return ((-r3 | r3) >>> 31) - 1;
  }
  ...
  @Method(0x8015068)
  public static void FUN_8015068(final Panel24 r0, final int r1, final int r2, final int r3, final int a4) {
    MEMORY.call(0x80164d4, r0, r1, r2, r3, a4);
  }
  ...
  /** {@link GoldenSun_801#FUN_8016498} */
  @Method(0x8015270)
  public static void FUN_8015270(final Panel24 r0) {
    MEMORY.call(0x8016498, r0);
  }
  ...
  @Method(0x8015298)
  public static int FUN_8015298(final int r0, final int r1, final int r2, final int r3) {
    return (int)MEMORY.call(0x801bcd4, r0, r1, r2, r3);
  }
  ...
  /** {@link GoldenSun_801#FUN_80170f8} */
  @Method(0x8015408)
  public static void FUN_8015408(final int x, final int y, final int w, final int h) {
    MEMORY.call(0x80170f8, x, y, w, h);
  }

  /** {@link GoldenSun_801#FUN_8016178} */
  @Method(0x8015410)
  ...
  @Method(0x8019ee4)
  public static void FUN_8019ee4(final int r0, final int r1, final int r2, final int r3, final int a4) {
    throw new RuntimeException("Not implemented");
  }

  @Method(0x801a088)
  public static int FUN_801a088(int r0, int r1) {
    int r2;
    int r3;
    final int r5;
    int r6;
    ...
    if(CPU.cpsr().getZero()) { // ==
      ...
      CPU.cmpT(r3, 0x0);
      if(!CPU.cpsr().getZero()) { // !=
        r3 = MEMORY.ref(4, 0x801a28c).get();
        r2 = CPU.addT(r5, r3);
        r3 = MEMORY.ref(4, 0x801a290).get();
        r1 = CPU.movT(0xc0);
      ...
      if(!CPU.cpsr().getZero()) { // !=
        ...
        CPU.cmpT(r3, 0x0);
        if(!CPU.cpsr().getZero()) { // !=
          r3 = MEMORY.ref(4, 0x801a29c).get();
          r3 = MEMORY.ref(4, r3 + 0x4).get();
          r1 = CPU.r9().value;
          r2 = CPU.r8().value;
          MEMORY.ref(4, r1).setu(r3);
          r0 = CPU.addT(r5, 0x0);
          MEMORY.ref(2, r2).setu(r6);
          r1 = CPU.movT(0x1);
          MEMORY.ref(2, r7).setu(r6);
          FUN_801a5a4(r0, r1);
        }
      ...
      if(!CPU.cpsr().getZero()) { // !=
        ...
        if(!CPU.cpsr().getZero()) { // !=
          ...
          r0 = MEMORY.ref(1, r2 + 0x3).getUnsigned();
          r3 = CPU.movT(0x1);
          r3 = CPU.andT(r3, r0);
          CPU.cmpT(r3, 0x0);
          if(!CPU.cpsr().getZero()) { // !=
      ...
      if(!CPU.cpsr().getZero()) { // !=
        ...
        if(CPU.cpsr().getZero() || CPU.cpsr().getNegative() != CPU.cpsr().getOverflow()) { // <=
          ...
          r0 = CPU.r10().value;
          r0 = modS(r0, r1);
          r3 = MEMORY.ref(4, 0x801a2a0).get();
          r0 = CPU.lslT(r0, 2);
          r2 = MEMORY.ref(4, 0x801a28c).get();
          CPU.r11().value = r3;
          r1 = CPU.movT(0xc0);
  ...
  @Method(0x801a2a4)
  public static int FUN_801a2a4(int r0, int r1, int r2) {
    int r3;
    int r5;
    final int r6;
    CPU.push(CPU.r10().value);
  ...
  @Method(0x801a3d0)
  public static void FUN_801a3d0(final int r0, final int r1, final int r2, final int r3, final int a4) {
    throw new RuntimeException("Not implemented");
  }
  ...
  public static void FUN_801f200(int r0) {
    ...
    r2 = MEMORY.ref(4, 0x801f308).get();
    r3 = CPU.addT(r1, r2);
    r3 = MEMORY.ref(1, r3).getUnsigned();
    if(r3 == 0 || FUN_80b5130(0, 0) == 0) {
      //LAB_801f31c
      r3 = CPU.movT(0x3);
      r4 = CPU.r11().value;
      r3 = CPU.negT(r3);
    ...
    if(CPU.cpsr().getZero()) { // ==
      ...
      if(CPU.cpsr().getZero()) { // ==
        ...
        //LAB_801f35a
        FUN_8016178(MEMORY.ref(2, r6 + 0x4).getUnsigned(), MEMORY.ref(2, r6 + 0x6).getUnsigned(), MEMORY.ref(2, r6 + 0x8).getUnsigned(), MEMORY.ref(2, r6 + 0xa).getUnsigned());
        ...
        FUN_80170f8(MEMORY.ref(2, r6 + 0x4).getUnsigned(), MEMORY.ref(2, r6 + 0x6).getUnsigned(), MEMORY.ref(2, r6 + 0x8).getUnsigned(), MEMORY.ref(2, r6 + 0xa).getUnsigned());
        FUN_801ef68(r8, CPU.r11().value);
      }
      ...
      if(!CPU.cpsr().getZero()) { // !=
        ...
        do {
          ...
          MEMORY.ref(1, r2 + 0xea7).setu(0xe);
          if(MEMORY.ref(1, r2 + 0xea5).getUnsigned() != 0) {
            MEMORY.ref(1, r2 + 0xea7).setu(0x5);
          }
      ...
      //LAB_801f4ea
      r0 = MEMORY.ref(4, CPU.sp().value + 0x20).get();
      r1 = MEMORY.ref(4, 0x801f5bc).get();
      r3 = CPU.movT(0x0);
      r2 = CPU.addT(r0, r1);
      CPU.r10().value = r3;
      r4 = MEMORY.ref(4, 0x801f5c0).get();
      r3 = CPU.movT(0xf);
      MEMORY.ref(1, r2).setu(r3);
      r3 = CPU.addT(r0, r4);
      r3 = MEMORY.ref(1, r3).getUnsigned();
