  ...
  public static void FUN_800c62c() {
    ...
    for(int i = 0; i < 0x40; i++) {
      ...
      if(actor._00.get() != 0) {
        ...
        //LAB_800c6a0
        int r1 = actor.pos_08.getX();
        int r2;
        int r6 = actor.spriteType_54.get() & 0xf;
        if(r1 != 0 || actor.pos_08.getZ() != 0) {
          //LAB_800c6ae
          if(r6 == 0) {
            break jmp_800c822;
          }
