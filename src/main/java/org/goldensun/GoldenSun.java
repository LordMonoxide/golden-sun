...
public final class GoldenSun {
  ...
  public static int FUN_80044d0(int r0, int r1) {
    ...
    if(r6 != 0) {
      ...
      if(r5 != 0) {
        //LAB_80044ea
        //LAB_80044f2
        r1 = FUN_80022ec(Math.abs(r6) << 8, Math.abs(r5));
        if(r1 <= 0xfb6a) {
          int r2 = 0x8007676;
  ...
  @Method(0x800e364)
  public static void FUN_800e364(final int r0, final int r1, final int r2) {
    if(r1 == 0) {
      MEMORY.ref(4, r0 + 0x18).setu(r2);
      //LAB_800e36e
    } else if(r1 == 1) {
      MEMORY.ref(4, r0 + 0x18).addu(r2);
      //LAB_800e37a
    } else if(MEMORY.ref(4, r0 + 0x18).get() == r2) {
      MEMORY.ref(1, r0 + 0x57).setu(1);
    } else {
      MEMORY.ref(1, r0 + 0x57).setu(0);
    }
  ...
  @Method(0x800e390)
  public static void FUN_800e390(final int r0, final int r1, final int r2) {
    if(r1 == 0) {
      MEMORY.ref(4, r0 + 0x1c).setu(r2);
      //LAB_800e39a
    } else if(r1 == 1) {
      MEMORY.ref(4, r0 + 0x1c).addu(r2);
      //LAB_800e3a6
    } else if(MEMORY.ref(4, r0 + 0x1c).get() == r2) {
      MEMORY.ref(1, r0 + 0x57).setu(1);
    } else {
      MEMORY.ref(1, r0 + 0x57).setu(0);
    }
  ...
  @Method(0x800e9dc)
  public static int FUN_800e9dc(final int r0) {
    final int r1 = MEMORY.ref(4, r0).get() + 0x4 + MEMORY.ref(2, r0 + 0x4).get() * 0x4;
  ...
  @Method(0x8009020)
  public static int FUN_8009020(final int r0, final int r1) {
  ...
  @Method(0x80090d0)
  public static void FUN_80090d0(final int r0) {
  ...
  @Method(0x800b168)
  public static void FUN_800b168(final int r0, int r1, int r2, int r3) {
    int r4;
    int r5;
    int r6;
    final int r8;
    ...
    MEMORY.ref(4, CPU.sp().value + 0x14).setu(r0 + 0x21);
    MEMORY.ref(4, CPU.sp().value + 0x18).setu(MEMORY.ref(1, r0 + 0x21).getUnsigned() >>> 1);
    ...
    {
      if(r5 != 0) {
        r2 = MEMORY.ref(2, r0 + 0x1e).getUnsigned();
      } else if(r8 != 0x10000) {
        r2 = MEMORY.ref(2, r0 + 0x1e).getUnsigned();
      } else if(r9 != r8) {
        r2 = MEMORY.ref(2, r0 + 0x1e).getUnsigned();
    ...
    r5 = r10 >> 16;
    if((MEMORY.ref(1, r0 + 0x26).getUnsigned() & 0x1) != 0) {
      if(r6 < 0xa0) {
        MEMORY.ref(1, r0 + 0x11).and(~0x3).oru(MEMORY.ref(4, CPU.sp().value + 0x8).get());
        MEMORY.ref(1, r0 + 0x13).and(~0x3e).oru((MEMORY.ref(4, CPU.sp().value + 0x20).get() & 0x1f) << 1);
        MEMORY.ref(2, r0 + 0x12).and(~0x1ff).oru(r5 - MEMORY.ref(4, CPU.sp().value + 0x10).get() & 0x1ff);
        MEMORY.ref(1, r0 + 0x10).setu(r6);
        insertIntoRenderQueue(MEMORY.ref(4, r0 + 0xc, RenderPacket0c::new), r4); //TODO
      } else {
        //LAB_800b2d8
        r5 = r10 >> 16;
      }
    ...
    //LAB_800b2dc
    r4 = (r5 - MEMORY.ref(4, CPU.sp().value + 0x1c).get()) + (r8 * (byte)MEMORY.ref(1, r0 + 0x22).getUnsigned() + 0xffff >> 16);
    r1 = (r11 - MEMORY.ref(4, CPU.sp().value + 0x4).get() >> 16) - MEMORY.ref(4, CPU.sp().value + 0x18).get();
    r2 = MEMORY.ref(4, CPU.sp().value + 0x14).get();
    r3 = r9 * ((MEMORY.ref(1, r2).getUnsigned() >>> 1) - (byte)MEMORY.ref(1, r0 + 0x23).getUnsigned()) + 0xffff >> 16;
    r6 = r1 - r3;
    if(r4 < 0xf0 && r6 < 0xa0) {
      MEMORY.ref(2, r0 + 0x6).and(~0x1ff).oru(r4 & 0x1ff);
      ...
      MEMORY.ref(1, r0 + 0x7).and(~0x3e).oru(MEMORY.ref(4, CPU.sp().value + 0x20).get() << 1);
      insertIntoRenderQueue(MEMORY.ref(4, r0, RenderPacket0c::new), MEMORY.ref(4, CPU.sp().value).get()); //TODO
    }
  ...
  public static int FUN_800bbc0(final int r0) {
    ...
    int r2 = boardWramMallocHead_3001e50.offset(3 * 0x4).get();
  ...
  @Method(0x800bc48)
  public static void FUN_800bc48(final int r0) {
    CPU.sp().value -= 0x4;
  ...
  public static int FUN_800bc70(final int r0) {
    ...
    int r5 = boardWramMallocHead_3001e50.offset(4 * 0x4).get();
  ...
  @Method(0x800bdd4)
  public static void FUN_800bdd4(int r0) {
    final int r2;
    int r3;
    int r5;
    int r6;
    ...
    CPU.cmpT(r7, 0x0);
    if(!CPU.cpsr().getZero()) { // !=
      r2 = MEMORY.ref(1, r7 + 0x1d).getUnsigned();
      r3 = CPU.movT(0, 0x1);
      r3 = CPU.andT(r3, r2);
      CPU.cmpT(r3, 0x0);
      if(CPU.cpsr().getZero()) { // ==
        r0 = MEMORY.ref(1, r7 + 0x1c).getUnsigned();
        r0 = FUN_8003f3c(r0);
      }
  ...
  @Method(0x800c0f4)
  public static void FUN_800c0f4(int r0) {
    int r2;
    int r3;
    int r5;
    int r6;
    ...
    if(!CPU.cpsr().getZero()) { // !=
      ...
      if(CPU.cpsr().getZero()) { // ==
        //LAB_800c112
        r0 = MEMORY.ref(4, r7 + 0x50).get();
        FUN_800bdd4(r0);
      } else {
        CPU.cmpT(r2, 0x2);
        if(CPU.cpsr().getZero()) { // ==
          //LAB_800c11a
          r5 = MEMORY.ref(4, r7 + 0x50).get();
          r6 = CPU.movT(0, 0x3);
  ...
  public static int FUN_800c150(int r0, int r1, int r2, int r3) {
    ...
    if(!CPU.cpsr().getZero()) { // !=
      ...
      if(CPU.cpsr().getZero()) { // ==
        ...
        if(CPU.cpsr().getZero()) { // ==
          //LAB_800c1cc
          r1 = boardWramMallocHead_3001e50.offset(6 * 0x4).get();
          r0 = r1 + 0x18;
  ...
  public static void FUN_800c62c() {
    ...
    r6 = boardWramMallocHead_3001e50.offset(5 * 0x4).get();
    r2 = MEMORY.ref(4, CPU.sp().value).get();
    CPU.r10().value = r6;
  ...
  @Method(0x800ca6c)
  public static void FUN_800ca6c(final int r0) {
    //LAB_800ca74
  ...
  @Method(0x800ca98)
  public static int FUN_800ca98(final int r0) {
    if(MEMORY.ref(1, r0 + 0x55).getUnsigned() == 0) {
      if(MEMORY.ref(4, r0 + 0x38).get() != 0x80000000 || MEMORY.ref(4, r0 + 0x3c).get() != 0x80000000) {
        return 0;
      }
    } else {
      //LAB_800cab2
      if(MEMORY.ref(4, r0 + 0x38).get() != 0x80000000) {
        return 0;
      }
    }

    //LAB_800cab8
    if(MEMORY.ref(4, r0 + 0x40).get() != 0x80000000) {
      return 0;
    }
  ...
  public static void FUN_800cacc() {
    ...
    r6 = boardWramMallocHead_3001e50.offset(5 * 0x4).get();
    MEMORY.ref(4, CPU.sp().value + 0x20).setu(0x3f);
    MEMORY.ref(4, CPU.sp().value + 0x4).setu(r6 + 0x55);
    MEMORY.ref(4, CPU.sp().value).setu(r6 + 0x56);
    ...
    do {
      ...
      if(!CPU.cpsr().getZero()) { // !=
        ...
        if(r2 != 0) {
          ...
          if(MEMORY.ref(1, r4 + 0x6).getUnsigned() == 0) {
            //LAB_800cb1a
            r0 = MEMORY.ref(4, CPU.sp().value).get();
            r1 = MEMORY.ref(2, r0 + 0x8).getUnsigned();
            if(MEMORY.ref(2, r0 + 0x8).get() != 0) {
              MEMORY.ref(2, r0 + 0x8).setu(r1 - 1);
            } else {
              //LAB_800cb2c
              //LAB_800cb36
              do {
                r3 = MEMORY.ref(2, r6 + 0x4).get();
                r3 = MEMORY.ref(4, r2 + r3 * 0x4).get();
                r1 = MEMORY.ref(2, r6 + 0x4).getUnsigned();
                CPU.cmpT(r3, 0x3f);
                if(CPU.cpsr().getCarry() && !CPU.cpsr().getZero()) { // unsigned >
                  MEMORY.ref(2, r6 + 0x4).setu(r1 - 1);
                  r2 = MEMORY.ref(4, r6).get();
                  continue;
                }
            ...
            //LAB_800cb5a
            MEMORY.ref(4, CPU.sp().value + 0x1c).setu(MEMORY.ref(4, r6 + 0x8).get());
            MEMORY.ref(4, CPU.sp().value + 0x18).setu(MEMORY.ref(4, r6 + 0xc).get());
            MEMORY.ref(4, CPU.sp().value + 0x14).setu(MEMORY.ref(4, r6 + 0x10).get());
            r4 = MEMORY.ref(4, CPU.sp().value + 0x4).get();
            if(MEMORY.ref(1, r4 + 0xc).getUnsigned() == 0) {
              //LAB_800cb70
              MEMORY.ref(4, CPU.sp().value + 0x8).setu(r4);
              if(MEMORY.ref(1, r4).getUnsigned() == 0) {
                //LAB_800cb7a
                r3 = MEMORY.ref(4, r6 + 0x38).get();
                if(r3 != 0x80000000) {
                  //LAB_800cb86
                  r0 = r3 - MEMORY.ref(4, CPU.sp().value + 0x1c).get();
                  if(r0 < 0) {
                  ...
                  if(r0 == 0) {
                    MEMORY.ref(4, CPU.sp().value + 0x1c).setu(MEMORY.ref(4, r6 + 0x38).get());
                    MEMORY.ref(4, CPU.sp().value + 0x18).setu(MEMORY.ref(4, r6 + 0x3c).get());
                    MEMORY.ref(4, CPU.sp().value + 0x14).setu(MEMORY.ref(4, r6 + 0x40).get());
                  } else {
                    //LAB_800cbe8
  ...
  @Method(0x800d14c)
  public static void FUN_800d14c(int r0, int r1, int r2, int r3) {
    int r4;
    int r5;
    int r6;
    final int r7;
    ...
    if(CPU.cpsr().getNegative() != CPU.cpsr().getOverflow()) { // <
      ...
      r0 = CPU.addT(r1, 0x0);
      r0 = CPU.lslT(r0, 0);
      CPU.r12().value = 0x800d1c8;
      r0 = (int)MEMORY.call(0x3000118, r0, r1);
      r4 = CPU.addT(r0, 0x0);
      r1 = CPU.addT(r5, 0x0);
      r0 = CPU.addT(r5, 0x0);
      r0 = CPU.lslT(r0, 0);
      CPU.r12().value = 0x800d1d4;
      r0 = (int)MEMORY.call(0x3000118, r0, r1);
      r5 = CPU.addT(r0, 0x0);
      r1 = CPU.addT(r6, 0x0);
      r0 = CPU.addT(r6, 0x0);
      r0 = CPU.lslT(r0, 0);
      CPU.r12().value = 0x800d1e0;
      r0 = (int)MEMORY.call(0x3000118, r0, r1);
      r4 = CPU.addT(r4, r5);
      r4 = CPU.addT(r4, r0);
      r0 = CPU.addT(r4, 0x0);
    ...
    if(CPU.cpsr().getNegative() != CPU.cpsr().getOverflow()) { // <
      ...
      MEMORY.ref(4, r7 + 0x38).setu(r3);
      MEMORY.ref(4, r7 + 0x3c).setu(r3);
      MEMORY.ref(4, r7 + 0x40).setu(r3);
    } else {
      //LAB_800d20c
      r3 = CPU.addT(r7, 0x0);
      r3 = CPU.addT(r3, 0x58);
      ...
      CPU.cmpT(r3, 0x0);
      if(CPU.cpsr().getZero()) { // ==
        r1 = MEMORY.ref(4, r7 + 0x30).get();
        r0 = CPU.addT(r1, 0x0);
        CPU.r12().value = 0x800d220;
        r0 = (int)MEMORY.call(0x3000118, r0, r1);
        r1 = CPU.addT(r0, 0x0);
        r0 = MEMORY.ref(4, r7 + 0x34).get();
        r0 = (int)MEMORY.call(0x300013c, r0, r1);
        r1 = CPU.addT(r0, 0x0);
        r5 = CPU.cmpT(r5, r1);
        if(!CPU.cpsr().getZero() && CPU.cpsr().getNegative() == CPU.cpsr().getOverflow()) { // >
        ...
        r0 = CPU.addT(r5, 0x0);
        r0 = (int)MEMORY.call(0x300013c, r0, r1);
        r4 = MEMORY.ref(4, r7 + 0x8).get();
        r5 = CPU.addT(r0, 0x0);
        r2 = CPU.r8().value;
        r0 = CPU.subT(r2, r4);
        r1 = CPU.addT(r5, 0x0);
        CPU.r12().value = 0x800d258;
        r0 = (int)MEMORY.call(0x3000118, r0, r1);
        r4 = CPU.addT(r4, r0);
        CPU.r8().value = r4;
        ...
        r0 = CPU.subT(r2, r4);
        r1 = CPU.addT(r5, 0x0);
        CPU.r12().value = 0x800d268;
        r0 = (int)MEMORY.call(0x3000118, r0, r1);
        r4 = CPU.addT(r4, r0);
        CPU.r10().value = r4;
        r4 = MEMORY.ref(4, r7 + 0x10).get();
        r2 = CPU.r9().value;
        r0 = CPU.subT(r2, r4);
        r1 = CPU.addT(r5, 0x0);
        CPU.r12().value = 0x800d278;
        r0 = (int)MEMORY.call(0x3000118, r0, r1);
        r4 = CPU.addT(r4, r0);
        CPU.r9().value = r4;
      }
  ...
  @Method(0x800d6a4)
  public static int FUN_800d6a4(final int r0) {
    final int r6 = MEMORY.ref(2, r0 + 0x4).get();
    ...
    //LAB_800d6c0
    if(MEMORY.ref(2, r0 + 0x4).get() == r6) {
      MEMORY.ref(2, r0 + 0x4).addu(0x2);
    }
  ...
  @Method(0x800d8e8)
  public static int FUN_800d8e8(final int r0) {
    FUN_800c0f4(r0);
    return 0;
  }
  ...
  public static int FUN_800d924(int r0, int r1) {
    ...
    r5 = boardWramMallocHead_3001e50.offset(5 * 0x4).get();
    r6 = CPU.addT(r5, 0x0);
    CPU.sp().value -= 0x4;
    r7 = CPU.addT(r0, 0x0);
    CPU.r8().value = r1;
