...
//    return 0x60;
  ...
  public static int loadSaveList() {
    ...
    do {
      ...
      r0 = compareBytes(r8, 0x80079b0, 7); // strcmp? r1 is CAMELOT
  ...
  @Method(0x8005810)
  public static int FUN_8005810(final int r0) {
    int r1;
    int r2;
    int r3;
    int r5;
    ...
    if(r6 != 0) {
      if(r6 == 1) {
        ...
        if(getSaveSlot(r0) == 0x10) {
          r5 = 0x10;
        }
      } else {
        //LAB_8005848
        r5 = MEMORY.ref(4, CPU.sp().value + modU(rand(), r6) * 0x4).get();
      }
    }
  ...
  @Method(0x8005868)
  public static int FUN_8005868(final int r0) {
    final int r6 = boardWramMallocHead_3001e50.offset(51 * 0x4).get() + 0x40;
    final int r5 = r0 & 0xffff;

    if((short)(int)MEMORY.call(MEMORY.ref(4, 0x2004c04).get(), r5, r6) != 0) {
      return 1;
    }

    //LAB_800588c
    final int r3 = FUN_8006c68(r5, r6);
  ...
  public static int loadSave(int r0) {
    ...
    CPU.sp().value -= 0x10;
    readFromSram(r0 & 0xffff, 0, r5, 0x1000);
  ...
  public static int FUN_8005920(final int r0, final int r1) {
    ...
    final int r10 = boardWramMallocHead_3001e50.offset(51 * 0x4).get();
    MEMORY.ref(4, CPU.sp().value).setu(0);
    DMA.channels[3].SAD.setu(CPU.sp().value);
    DMA.channels[3].DAD.setu(r10 + 0x40);
    DMA.channels[3].CNT.setu(0x85000400);
    ...
    DMA.channels[3].DAD.setu(r10 + 0x50);
    DMA.channels[3].CNT.setu(0x840003fc);
    ...
    DMA.channels[3].SAD.setu(0x80079b8); // Camelott
    DMA.channels[3].DAD.setu(CPU.sp().value + 0x4);
    ...
    MEMORY.ref(2, r5 + 0x8).setu(calcSaveChecksum());
    MEMORY.ref(2, r5 + 0xa).setu(FUN_8005c2c(r0) + 1);
    DMA.channels[3].SAD.setu(r5);
    DMA.channels[3].DAD.setu(r10 + 0x40);
    DMA.channels[3].CNT.setu(0x84000004);
    ...
    //LAB_80059ec
    if(MEMORY.ref(2, r5 + 0xa).getUnsigned() > 65000) {
      MEMORY.ref(2, r5 + 0xa).setu(0x1);
      DMA.channels[3].SAD.setu(r5);
      DMA.channels[3].DAD.setu(r10 + 0x40);
      DMA.channels[3].CNT.setu(0x84000004);
    ...
    //LAB_8005a2c
    MEMORY.ref(1, r10 + r6).setu(0x1);
    MEMORY.ref(1, r10 + r6 + 0x10).setu(r0);
    MEMORY.ref(2, r10 + 0x20 + r6 * 0x2).setu(MEMORY.ref(2, r5 + 0xa).getUnsigned());
  ...
  @Method(0x8005a78)
  public static int FUN_8005a78(int r0, int r1) {
    int r2;
    int r3;
    final int r5;
    final int r6;

    r3 = MEMORY.ref(4, 0x8005ab4).get();
    r6 = CPU.addT(r1, 0x0);
    ...
    if(CPU.cpsr().getCarry() && !CPU.cpsr().getZero()) { // unsigned >
      ...
      r0 = loadSave(r0);
      r0 = CPU.addT(r5, 0x0);
      r3 = MEMORY.ref(4, 0x8005ab8).get();
      r0 = CPU.addT(r0, 0x50);
      r1 = CPU.addT(r6, 0x0);
      r2 = MEMORY.ref(4, 0x8005abc).get();
  ...
  public static int FUN_8005b64(final int r0) {
    ...
    final int r6 = boardWramMallocHead_3001e50.offset(51 * 0x4).get();
    MEMORY.ref(4, CPU.sp().value).setu(0);
    DMA.channels[3].SAD.setu(CPU.sp().value);
    DMA.channels[3].DAD.setu(CPU.sp().value + 0x4);
    ...
    MEMORY.ref(1, CPU.sp().value + 0x4 + 0x7).setu(0x10);
    MEMORY.ref(2, CPU.sp().value + 0x4 + 0xa).setu(0);
    DMA.channels[3].SAD.setu(CPU.sp().value + 0x4);
    DMA.channels[3].DAD.setu(r6 + 0x40);
    DMA.channels[3].CNT.setu(0x84000004);
    ...
    if(FUN_8005868(r0) != 0) {
      ...
      //LAB_8005bd6
      MEMORY.ref(1, r6 + r0).setu(0);
      MEMORY.ref(1, r6 + r0 + 0x10).setu(0x10);
      MEMORY.ref(2, r6 + 0x20 + r0 * 0x2).setu(0);
      ret = 0;
    }
  ...
  public static int FUN_8005c2c(final int r0) {
    final int r3 = boardWramMallocHead_3001e50.offset(51 * 0x4).get();
    int ret = 0;

    //LAB_8005c3e
    for(int r4 = 0; r4 < 0x10; r4++) {
      if(MEMORY.ref(1, r3 + r4).getUnsigned() != 0) {
        if(r0 == MEMORY.ref(1, r3 + r4 + 0x10).getUnsigned()) {
          ret = Math.max(ret, MEMORY.ref(2, r3 + 0x20 + r4 * 0x2).getUnsigned());
        }
      }
  ...
  public static int loadSavePreview() {
    ...
    for(int saveFile = 0; saveFile < 3; saveFile++) {
      ...
      if(saveSlot < 16) {
        readFromSram(saveSlot & 0xffff, 0, r5, 0x40);
        saveCount++;
      }
      ...
      if(saveSlot < 16) {
        readFromSram(saveSlot & 0xffff, 0x110, r5 + 0x38, 0x4);
      } else {
        //LAB_8005cd0
  ...
  public static void readFromSram(final int saveSlot, final int offset, final int dest, final int size) {
    ...
    final int r4 = (saveSlot & 0xffff) << MEMORY.ref(1, 0x8007abc + 0x1c).getUnsigned();
    MEMORY.call(CPU.sp().value + 0x1, 0xe000000 + r4 + offset, dest, size);
    CPU.sp().value += 0x80;
  }

  @Method(0x8006c24)
  public static int FUN_8006c24(int r0, int r1, int r2) {
    int r3;
    int r4;
    final int r5;
    ...
    r3 = CPU.addT(r1, 0x0);
    r2 = CPU.lslT(r2, 16);
    r2 = CPU.addT(r2, 0xffff0000);
    r2 = CPU.lsrT(r2, 16);
    r2 = CPU.cmpT(r2, 0xffff);
    if(!CPU.cpsr().getZero()) { // !=
      r5 = 0xffff;
  ...
  @Method(0x8006c68)
  public static int FUN_8006c68(int r0, int r1) {
    int r2;
    int r3;
    final int r4;
    final int r5;
    ...
    //LAB_8006cb0
    while(r1 != 0) {
      MEMORY.ref(2, r2).setu(MEMORY.ref(2, r3).getUnsigned());
      r3 += 0x2;
      r2 += 0x2;
      r0 = r1 - 1;
      r0 = r0 << 16;
    ...
    r0 = 0x8007abc;
    final int ret = (int)MEMORY.call(CPU.sp().value + 0x1, r5, 0xe000000 + (r4 << MEMORY.ref(1, r0 + 0x1c).getUnsigned()), MEMORY.ref(2, r0 + 0x18).getUnsigned());
    CPU.sp().value += 0x100;
    return ret;
  }
  ...
  /** {@link GoldenSun#FUN_800b168} */
  @Method(0x8009008)
  public static void FUN_8009008(final Sprite38 r0, final int r1, final int r2, final int r3) {
  ...
  /** {@link GoldenSun#FUN_800bdd4} */
  @Method(0x8009038)
  public static void FUN_8009038(final Sprite38 r0) {
...
//      return -1;
  ...
  public static int FUN_800eaf8() {
    ...
    final int r5;
    if((pressedButtons_3001c94.get() & MEMORY.ref(2, 0x2000454).getUnsigned()) != 0) {
      MEMORY.ref(2, r1 + 0x172).setu(0x1);
      r5 = 0x1;
      //LAB_800eb1e
    } else if((pressedButtons_3001c94.get() & MEMORY.ref(2, 0x2000450).getUnsigned()) != 0) {
      MEMORY.ref(2, r1 + 0x174).setu(0x1);
      r5 = 0x1;
      //LAB_800eb32
    } else if((pressedButtons_3001c94.get() & MEMORY.ref(2, 0x2000456).getUnsigned()) != 0) {
      MEMORY.ref(2, r1 + 0x176).setu(0x1);
      r5 = 0x1;
      //LAB_800eb4e
    } else if((pressedButtons_3001c94.get() & MEMORY.ref(2, 0x2000458).getUnsigned()) != 0) {
      r5 = FUN_800ea60(MEMORY.ref(2, 0x2000460).getUnsigned());
      //LAB_800eb64
    } else if((pressedButtons_3001c94.get() & MEMORY.ref(2, 0x200045a).getUnsigned()) != 0) {
      r5 = FUN_800ea60(MEMORY.ref(2, 0x2000462).getUnsigned());
    } else {
      r5 = 0;
    }
  ...
  public static int FUN_800ea60(final int r0) {
    ...
    if(FUN_80770c0(0x107) != 0) {
      MEMORY.ref(2, r5 + 0x182).setu(0xfa);
      //LAB_800ea82
    } else if(MEMORY.ref(2, r5 + 0x19e).get() == 3) {
      if((pressedButtons_3001c94.get() & 0x100) != 0) {
        MEMORY.ref(2, r5 + 0x182).setu(0xfc88);
        //LAB_800eaaa
      } else if((pressedButtons_3001c94.get() & 0x200) != 0) {
        MEMORY.ref(2, r5 + 0x182).setu(0xfc87);
      }
      //LAB_800eac2
    } else if(r6 == 0) {
      //LAB_800eacc
      MEMORY.ref(2, r5 + 0x17e).setu(r7);
    } else if(r6 == 1) {
      //LAB_800ead0
      MEMORY.ref(2, r5 + 0x180).setu(r7);
    }
  ...
  public static int FUN_800ebec(final Actor70 r0) {
    ...
    if(debug_3001f54.get() != 0 && FUN_80770c0(0x15e) != 0) {
      int count = 0;
    ...
    //LAB_800ec78
    if((heldButtonsLastFrame_3001ae8.get() & MEMORY.ref(2, 0x200045c).getUnsigned()) != 0) {
      r0._30.set(0x18000);
      r0._34.set(0x4000);
      MEMORY.ref(4, CPU.sp().value + 0x8).setu(0x5);
    } else {
      //LAB_800ec9c
      r0._30.set(0x10000);
      r0._34.set(0x4000);
    ...
    //LAB_800ecac
    if(FUN_80770c0(0x17f) != 0 && (heldButtonsLastFrame_3001ae8.get() & 0x2) != 0) {
      r0._30.set(0x40000);
      r0._34.set(0x10000);
      MEMORY.ref(4, CPU.sp().value + 0x8).setu(0x5);
    }
    ...
    //LAB_800ecd6
    r3 = MEMORY.ref(2, 0x8013254 + (heldButtonsLastFrame_3001ae8.get() >>> 4 & 0xf) * 0x2).get() << 16;
    MEMORY.ref(4, CPU.sp().value + 0x4).setu(r3);
    r1 = r3 >>> 16;

    jmp_800f0c6:
    if(r1 == 0xffff) {
      MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x4);
    } else {
      //LAB_800ecfa
      MEMORY.ref(4, CPU.sp().value + 0x14).setu(0);
      r11 = CPU.sp().value + 0x5c;
      MEMORY.ref(4, r11).setu(r0.pos_08.getX());
      MEMORY.ref(4, r11 + 0x4).setu(r0.pos_08.getY());
      MEMORY.ref(4, r11 + 0x8).setu(r0.pos_08.getZ());
      rotVec3(0x80000, r1, r11);

      if(debug_3001f54.get() != 0) {
        MEMORY.ref(4, CPU.sp().value + 0xc).setu(MEMORY.ref(4, CPU.sp().value + 0x4).get() >> 16);
        if((heldButtonsLastFrame_3001ae8.get() & 0x200) != 0) {
          break jmp_800f0c6;
        }
      }
      ...
      {
        //LAB_800ed38
        if(FUN_80120dc(r0, r11) == 0) {
          r5 = CPU.sp().value + 0x50;
          MEMORY.ref(4, r5).setu(r0.pos_08.getX());
          MEMORY.ref(4, r5 + 0x4).setu(r0.pos_08.getY());
          MEMORY.ref(4, r5 + 0x8).setu(r0.pos_08.getZ());
          r6 = MEMORY.ref(4, CPU.sp().value + 0x4).get() >>> 16;
          rotVec3(0x80000, r6 + 0x1000, r5);

          if(FUN_80120dc(r0, r5) == 0) {
            MEMORY.ref(4, r5).setu(r0.pos_08.getX());
            MEMORY.ref(4, r5 + 0x4).setu(r0.pos_08.getY());
            MEMORY.ref(4, r5 + 0x8).setu(r0.pos_08.getZ());
            rotVec3(0x80000, r6 - 0x1000, r5);
            ...
            if(FUN_80120dc(r0, r5) == 0) {
              ...
              if(FUN_80120dc(r0, r5) == 0) {
                ...
                if(FUN_80120dc(r0, r5) == 0) {
                  r1 = MEMORY.ref(4, CPU.sp().value + 0x4).get() >> 16;
                  MEMORY.ref(4, CPU.sp().value + 0xc).setu(r1);
                  MEMORY.ref(4, CPU.sp().value).setu(r1 << 16);
                  break jmp_800ef44;
                }
              }
            }
        ...
        r3 = MEMORY.ref(4, CPU.sp().value + 0x4).get() >>> 16;
        ...
        //LAB_800ee50
        for(r9 = 0; r9 < 6; r9++) {
          r1 = MEMORY.ref(2, r10 + r9 * 0x2).get();
          MEMORY.ref(4, CPU.sp().value + 0xc).setu(r1);
          MEMORY.ref(4, r11).setu(r0.pos_08.getX());
          MEMORY.ref(4, r11 + 0x4).setu(r0.pos_08.getY());
          MEMORY.ref(4, r11 + 0x8).setu(r0.pos_08.getZ());
          ...
          rotVec3(0x80000, r6, r11);

          if(FUN_80120dc(r0, r11) == 0) {
            MEMORY.ref(4, CPU.sp().value + 0x50).setu(r0.pos_08.getX());
            MEMORY.ref(4, CPU.sp().value + 0x54).setu(r0.pos_08.getY());
            MEMORY.ref(4, CPU.sp().value + 0x58).setu(r0.pos_08.getZ());
            rotVec3(0x80000, r6 + 0x1000, CPU.sp().value + 0x50);

            if(FUN_80120dc(r0, CPU.sp().value + 0x50) == 0) {
              MEMORY.ref(4, CPU.sp().value + 0x50).setu(r0.pos_08.getX());
              MEMORY.ref(4, CPU.sp().value + 0x54).setu(r0.pos_08.getY());
              MEMORY.ref(4, CPU.sp().value + 0x58).setu(r0.pos_08.getZ());
              rotVec3(0x80000, r6 - 0x1000, CPU.sp().value + 0x50);
              ...
              if(FUN_80120dc(r0, CPU.sp().value + 0x50) == 0) {
                ...
                MEMORY.ref(4, CPU.sp().value + 0x54).setu(r0.pos_08.getY());
                MEMORY.ref(4, CPU.sp().value + 0x58).setu(r0.pos_08.getZ());
                rotVec3(0x80000, r6 + 0x2000, CPU.sp().value + 0x50);
        ...
        MEMORY.ref(4, r11 + 0x4).setu(r0.pos_08.getY());
        MEMORY.ref(4, r11 + 0x8).setu(r0.pos_08.getZ());
        MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x1);
      }
      ...
      MEMORY.ref(4, r11 + 0x4).setu(r0.pos_08.getY());
      MEMORY.ref(4, r11 + 0x8).setu(r0.pos_08.getZ());
      rotVec3(0x40000, MEMORY.ref(4, CPU.sp().value).get() >>> 16, r11);
      ...
      //LAB_800ef72
      for(r9 = 0; r9 < 0x40; r9++) {
        final Actor70 r8 = actors.get(r9);
        if(r8._00.get() != 0) {
          //LAB_800ef80
          if((r8._59.get() & 0x1) != 0) {
            //LAB_800ef90
            if(r8 != r0) {
              //LAB_800ef96
              if(FUN_800eba0(r8.pos_08.getAddress(), r0.radius_20.get() - 2, r11, r8.radius_20.get() - 2) >= 0) {
                if((r8._58.get() & 0xff000200) != 0x200) {
                  MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x2);
                } else {
                  final int angle = atan2(r8.pos_08.getZ() - r0.pos_08.getZ(), r8.pos_08.getX() - r0.pos_08.getX());
                  r5 = CPU.sp().value + 0x50;
                  MEMORY.ref(4, r5).setu(r8.pos_08.getX());
                  MEMORY.ref(4, r5 + 0x4).setu(r8.pos_08.getY());
                  final int angle2 = angle & 0xffff;
                  MEMORY.ref(4, r5 + 0x8).setu(r8.pos_08.getZ());
                  MEMORY.ref(4, CPU.sp().value + 0xc).setu((short)angle);
                  rotVec3(0x4000, angle2, r5);

                  if(FUN_800d924(r8, r5) != 0) {
                    MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x2);
                  } else {
                    MEMORY.ref(4, r5).setu(r8.pos_08.getX());
                    MEMORY.ref(4, r5 + 0x4).setu(r8.pos_08.getY());
                    MEMORY.ref(4, r5 + 0x8).setu(r8.pos_08.getZ());
                    rotVec3(0xa0000, angle2, r5);

                    if(FUN_80120dc(r8, r5) != 0) {
                      MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x2);
                    } else {
                      MEMORY.ref(4, r5).setu(r8.pos_08.getX());
                      MEMORY.ref(4, r5 + 0x4).setu(r8.pos_08.getY());
                      MEMORY.ref(4, r5 + 0x8).setu(r8.pos_08.getZ());
                      rotVec3(0xa0000, angle2 + 0x1000, r5);

                      if(FUN_80120dc(r8, r5) != 0) {
                        MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x2);
                      } else if(FUN_80120dc(r8, r5) != 0) {
                        MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x2);
                      } else {
                        MEMORY.ref(4, r5).setu(r8.pos_08.getX());
                        MEMORY.ref(4, r5 + 0x4).setu(r8.pos_08.getY());
                        ...
                        final int distance = FUN_80120dc(r8, r5);
                        if(distance == 0) {
                          rotVec3(distance, angle2, 0x4000);
                          r8.dest_38.setX(0x80000000);
                          r8.dest_38.setY(0x80000000);
                          r8.dest_38.setZ(0x80000000);
                          MEMORY.ref(4, CPU.sp().value + 0x10).oru(0x1);
                        } else {
                          //LAB_800f092
                          MEMORY.ref(4, CPU.sp().value + 0x14).oru(0x2);
                        }
    ...
    if(r3 != 0) {
      if((MEMORY.ref(4, CPU.sp().value + 0x14).get() & 0x3) != 0) {
    ...
    if(MEMORY.ref(4, CPU.sp().value + 0x10).get() != 0) {
      FUN_800c300(r0, 0x8);
      //LAB_800f0fe
    } else if(MEMORY.ref(4, CPU.sp().value + 0x14).get() != 0) {
      if(MEMORY.ref(2, FUN_8077008(MEMORY.ref(4, 0x2000240 + 0x1f4).get()) + 0x38).get() != 0) {
        r5 = 0x16;
      } else {
        r5 = 0x9;
      }
      ...
      //LAB_800f128
      FUN_800c300(r0, MEMORY.ref(4, CPU.sp().value + 0x8).get());
    }
    ...
    if(r2 != 0) {
      ...
      r0.velocity_24.setX(r3);
      r0.velocity_24.setZ(r3);
      rotVec3(sqrt, MEMORY.ref(4, CPU.sp().value + 0xc).get() & 0xffff, r0.velocity_24.getAddress());
      if(r0._64.get() != 0) {
        r0._64.decr();
      }
    }
    ...
    //LAB_800f1fa
    r3 = boardWramMallocHead_3001e50.offset(8 * 0x4).deref(4).cast(Map194::new)._17.get();
    final int r8_0 = MEMORY.ref(4, CPU.sp().value + 0x4).get() >>> 16;
    if(r3 != 0) {
      if(r0._64.get() == 0) {
        if(MEMORY.ref(4, CPU.sp().value + 0x14).get() == 0) {
          ...
          if(actor != null) {
            ...
            FUN_800c2d8(actor, 0x8013274);
            actor.flags_23.set(0x2);
            actor._55.set(MEMORY.ref(1, CPU.sp().value + 0x14).getUnsigned());
            if(sprite != null) {
              FUN_800ba30(sprite, 0x1);
              sprite._26.set(MEMORY.ref(1, CPU.sp().value + 0x14).getUnsigned());
              sprite.rotation_1e.set(r8_0 + 0x4000);
              sprite.packet_00.attribs_04.attrib2_04.or(0xc00);
            }

            //LAB_800f270
            if(r0._66.get() == 2) {
              FUN_800ba30(sprite, 0x2);
              r0._66.set(MEMORY.ref(2, CPU.sp().value + 0x14).getUnsigned());
              r2 = 0;
            } else {
              r2 = r0._66.get();
            }
            ...
            //LAB_800f2a0
            if(MEMORY.ref(4, CPU.sp().value + 0x8).get() == 5) {
              r0._64.set(0xc);
            } else {
              //LAB_800f2c0
              r0._64.set(0x12);
