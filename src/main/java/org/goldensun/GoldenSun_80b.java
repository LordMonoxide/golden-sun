...
public final class GoldenSun_80b {
  ...
  public static int FUN_80b6cd0(final int r0) {
    return getCombatantForUnit(r0)._14.get();
  }
  ...
  public static void FUN_80b9470(final ArrayRef<BattleStruct82c.Turn10> turns, final int r1) {
    ...
    //LAB_80b948c
    for(int i = 0; i < r1; i++) {
      final BattleStruct82c.Turn10 r5 = turns.get(i);
      if(r5._06.get() == 0x5) {
        int r2 = r5._08.get();
        r2 = MEMORY.ref(1, getAbility_(FUN_80771e8(r2 >> 8 & 0xf, r2 & 0xff)) + 0x3).getUnsigned();
        final int r3 = r2 + 210 << 24;
        if((r3 & 0xffff_ffffL) <= 0x1000000 || r2 == 0x35) {
          //LAB_80b94c8
          r5.agility_04.add(10000);
        }
      }
  ...
  @Method(0x80b9a70)
  public static int FUN_80b9a70(int r0) {
    int r1;
    int r2;
    int r3;
    final int r4;
  ...
  public static int FUN_80ba2c0(final BattleStruct82c.Sub64 r0_0, int r1) {
    ...
    if(r3 == 0x87) {
      r3 = 0x3001e74;
      r3 = MEMORY.ref(4, r3).get();
      FUN_8015130(MEMORY.ref(1, r3 + 0x41).getUnsigned() & ~0x1);
    }
  ...
  @Method(0x80ba978)
  public static void FUN_80ba978(final BattleStruct82c.Sub64 r0, final int r1) {
    throw new RuntimeException("Not implemented");
  }
  ...
  @Method(0x80bae40)
  public static int FUN_80bae40(final int r0, final int r1) {
    throw new RuntimeException("Not implemented");
  }
  ...
  @Method(0x80bbb0c)
  public static void FUN_80bbb0c(int r0, int r1) {
    int r2;
    int r3;
    int r4;
    int r5;
    ...
    r4 = MEMORY.ref(4, CPU.sp().value + 0x50).get();
    r2 = r2 + 0x2;
    r3 = MEMORY.ref(1, r2 + r6).getUnsigned();
    r4 = MEMORY.ref(4, r4 + 0x4c).get();
    CPU.r10().value = r3;
    ...
    CPU.r8().value = r2;
    r0 = getAbility_(r0);
    MEMORY.ref(4, CPU.sp().value + 0x4c).setu(r0);
    ...
    if(r1 != 0x4) {
      ...
      if(r0 <= r3) {
        ...
        } while(r0 <= MEMORY.ref(2, r2 + 0x2).get());
      }
    ...
    if(r3 == 0x5 && (r2 & 0xffff_ffffL) <= (0x3 & 0xffff_ffffL)) {
    ...
    r3 = MEMORY.ref(1, r4 + 0x1).getUnsigned();
    r5 = 0xf;
    r5 = r5 & r3;
    ...
    r5 = MEMORY.ref(4, CPU.sp().value + 0x4c).get();
    ...
    if((r3 & 0xffff_ffffL) <= (r6 & 0xffff_ffffL)) {
      ...
      if(r4 != 0 && FUN_80b6cdc(r5) != 0 && CPU.r8().value >= 0) {
        r0 = r5;
        r1 = 0x1;
        r0 = FUN_80c1df4(r0);
        r3 = 0x80;
        ...
        if(r3 == 0xfe) {
          ...
          do {
            r6 = CPU.r12().value;
            r2 = MEMORY.ref(2, r0 + r6).get();
            if(r2 == 0xff) {
              //LAB_80bbd34
              r3 = CPU.lr().value;
              r4 = CPU.r8().value;
              r3 = r3 + 0x66;
              MEMORY.ref(2, r1 + r0).setu(r4);
        ...
        FUN_80b7548();
        r0 = CPU.r8().value;
        final BattleStruct82c.Combatant2c combatant = getCombatantForUnit(r0);
        r2 = combatant.x_0c.get();
        if(r2 < 0) {
          r3 = 0xffff;
          r2 = r2 + r3;
        }
        ...
        r3 = r3 >> 16;
        r1 = CPU.r8().value;
        initCombatant(combatant, r1, r2, r3);
        loadAllUnitSpritesAndSetAnimations();
    ...
    if(r2 != 0) {
      ...
      r2 = MEMORY.ref(1, r3 + 0x3).getUnsigned();
      r3 = r2;
      if(r3 != 0x35) {
        //LAB_80bbe1e
        r3 = r2;
        ...
        r4 = 0x0;
        MEMORY.ref(4, CPU.sp().value + 0x24).setu(r4);
        r3 = 0xbb;
        r5 = MEMORY.ref(4, CPU.sp().value + 0x38).get();
        r3 = r3 << 2;
        r3 = MEMORY.ref(2, r5 + r3).get();
        r2 = 0x0;
        if(r3 == CPU.r10().value) {
          r0 = 0x1;
          MEMORY.ref(4, CPU.sp().value + 0x24).setu(r0);
          ...
          do {
            ...
            if(r3 == CPU.r10().value) {
              r6 = 0x1;
              MEMORY.ref(4, CPU.sp().value + 0x24).setu(r6);
              break;
            }
          } while(true);
        }
    ...
    if(r2 == 0) {
      ...
      if(r3 != 0 || FUN_80772b8(MEMORY.ref(1, MEMORY.ref(4, CPU.sp().value + 0x4c).get() + 0x3).getUnsigned()) != 0) {
        //LAB_80bbeb8
        ...
        switch(r3) {
          ...
          case 4: // switch 80bbecc
            ...
            do {
              ...
              r5 = MEMORY.ref(2, r3 + 0xa).getUnsigned();
              if(r4 == 0x4) {
          ...
          case 11: // switch 80bbecc
            ...
            if(r3 != 0) {
              ...
              r5 = MEMORY.ref(2, r0 + 0xa).getUnsigned();
              r2 = 0x80;
          ...
          case 2: // switch 80bbecc
            //LAB_80bc150
            r4 = MEMORY.ref(4, CPU.sp().value + 0x4c).get();
            r3 = MEMORY.ref(2, r4 + 0xa).getUnsigned();
            if(r3 != 0) {
              //LAB_80bc15a
              r0 = CPU.r9().value;
              r5 = 0x38;
          ...
          case 0: // switch 80bbecc
            ...
            if(r3 != 0) {
              ...
              r5 = MEMORY.ref(2, r1 + 0xa).getUnsigned();
              r2 = 0x80;
              r1 = MEMORY.ref(4, CPU.sp().value + 0x3c).get();
              r2 = r2 << 1;
              r0 = r5;
    ...
    FUN_80bbabc(r0, r1);
    r5 = MEMORY.ref(4, CPU.sp().value + 0x4c).get();
    r0 = MEMORY.ref(1, r5 + 0x3).getUnsigned();
    r0 = FUN_80772b8(r0);
    if(r0 != 0 || MEMORY.ref(2, r7 + 0x38).get() != 0 || FUN_80bbae8(MEMORY.ref(1, r5 + 0x3).getUnsigned()) != 0) {
      //LAB_80bc690
    ...
    if(r3 != 0) {
      ...
      if(r0 == 0) {
        ...
        if(r1 > 0) {
          ...
          //LAB_80bd354
          r2 = MEMORY.ref(4, CPU.sp().value + 0x50).get();
          r3 = MEMORY.ref(4, r2 + 0x60).get();
          r3 = r3 + r0;
          MEMORY.ref(4, r2 + 0x60).setu(r3);
        }
      }
    }
  ...
  @Method(0x80bd3c8)
  public static int FUN_80bd3c8(int r0) {
    final int r3;
  ...
  public static int FUN_80bd3e4(int r0) {
    ...
    if(r0 >= r2) {
      ...
      do {
        ...
        r3 = MEMORY.ref(1, r5 + r1).getUnsigned();
        r2 = r2 + r3;
        if(r0 < r2) {
          r4 = r1;
          break;
  ...
  @Method(0x80bd424)
  public static void FUN_80bd424(final BattleStruct82c.Turn10 turn, int r1) {
    int r0;
    int r2;
    int r3;
    int r5;
        ...
        do {
          ...
          switch(r3) {
            ...
            case 3: // switch 80bd4a0
              ...
              r10 = r3;
              if(r0 != 0) {
                r11._120.and(~0xe).or((r10 + 1 & 0x7) << 1);
              }
              break;
          ...
          r6 = MEMORY.ref(1, r2).getUnsigned();
          r3 = r10;
          r6 = r6 >> r3;
          r1 = r10;
          r3 = 0x1;
          ...
          if(r1 != 0) {
            ...
            //LAB_80bd61e
            r2 = turn._06.get();
            if(MEMORY.ref(4, CPU.sp().value + 0x18).get() == 0 && r2 != 0x3 && r2 != 0x7) {
              break;
            }
            ...
            if(r3 != r1) {
              ...
              if(r0 == 0) {
                ...
                if(r2 > r3 && MEMORY.ref(1, MEMORY.ref(4, CPU.sp().value + 0x14).get() + 0x35).get() != 0) {
                  break jmp_80bd770;
                }

                //LAB_80bd658
                if(r11._13d.get() != 0 && MEMORY.ref(1, MEMORY.ref(4, CPU.sp().value + 0x14).get() + 0x35).get() == 0x2) {
                  break jmp_80bd770;
                }
            ...
            if(r2 != 0x63 || r11._148.get() == 0) {
              ...
              if(r3 == 0 || r2 != 0x3 && r2 != 0x7) {
                ...
                //LAB_80bd6d6
                r3 = MEMORY.ref(1, r5 + 0x8).getUnsigned();
                turn._0c.set(r3);
                r3 = MEMORY.ref(1, r5).getUnsigned();
    ...
    if(r3 != 0) {
      ...
      do {
        do {
          do {
                ...
                if(r5 < r3) {
                  ...
                  do {
                    ...
                    switch(r3) {
                      ...
                      case 9: {
                        //LAB_80bda82
                        r0 = MEMORY.ref(4, r7 + 0x40 + r6 * 0x4).get();
                        MEMORY.ref(4, r7 + 0x164).setu(r0);
                        FUN_80c24f0(r0, MEMORY.ref(4, r7 + 0x16c).get());
                        r0 = MEMORY.ref(4, r7 + 0x164).get();
                        FUN_80bb588(r0);
                        final Unit14c unit = getCharOrMonsterData_(MEMORY.ref(4, r7 + 0x164).get());

                        //LAB_80bdaca
                        for(r5 = 0; ; r5++) {
                          final Sprite38 sprite = getActorSprite(getCombatantForUnit(MEMORY.ref(4, r7 + 0x164).get()).actor_00.deref(), r5);
                          if(sprite == null) {
                            break;
                          }
                        ...
                        if(unit._12a.get() == 0x1) {
                          MEMORY.ref(4, r7 + 0x148).setu(11);
                          MEMORY.ref(4, r7 + 0x150).setu(r0);
                        }
                        break;
                      }
                      ...
                      case 11: // switch 80bd960
                        //LAB_80bdb10
                        r5 = 0x40 + r6 * 0x4;
                        FUN_80b78e4(MEMORY.ref(4, r7 + r5).get(), getCombatantForUnit(MEMORY.ref(4, r7 + r5).get()));
                        FUN_80ba918(getCombatantForUnit(MEMORY.ref(4, r7 + r5).get()).actor_00.deref(), FUN_80b6cd0(MEMORY.ref(4, r7 + r5).get()));
                        FUN_80b7aac(MEMORY.ref(4, r7 + r5).get());
                        break;
                    }
            ...
            //LAB_80bdcbc
            r4 = r11;
            r3 = MEMORY.ref(2, r4 + 0xe).getUnsigned();
            r1 = MEMORY.ref(4, CPU.sp().value + 0x4).get();
            r2 = r0 >> 15;
            r3 = r3 << 3;
            r2 = r2 + r3;
            ...
            r3 = heldButtonsLastFrame_3001ae8.get() & 0x2;
            if(r3 == 0 && (accumulatedButtons_3001af8.get() & 0x303) == 0 && (((ticks_3001800.get() - MEMORY.ref(4, r7 + 0x150).get()) & 0xffff_ffffL) <= 10 || (heldButtonsLastFrame_3001ae8.get() & 0x303) == 0)) {
              //LAB_80bdd22
              insertIntoRenderQueue(MEMORY.ref(4, r9, RenderPacket0c::new), 240);
              CPU.sp().value += 0x2c;
              return;
            }
            //LAB_80bdd06
          ...
          if(r3 != 0) {
            ...
            if(r3 != 0) {
              ...
              r3 = r3 + 0x65;
              r5 = r7 + r3;
              FUN_80ba918(getCombatantForUnit(MEMORY.ref(4, r5).get()).actor_00.deref(), FUN_80b6cd0(MEMORY.ref(4, r5).get()));
            } else {
              //LAB_80bdd6e
              r1 = 0xb2;
              r1 = r1 << 1;
      ...
      if(r3 == 0 || r3 >= 0x400) {
        ...
        if(r3 == 0) {
          ...
          r3 = MEMORY.ref(4, r3).get();
          if(r3 != 0) {
            r0 = FUN_80c2368(getCharOrMonsterData_(MEMORY.ref(4, r7 + 0x164).get()).id_128.get());
            if(r0 >= 0) {
              r0 = r0 - 0x1;
              if(r0 < 0) {
                r0 = 0x0;
        ...
        //LAB_80bde7c
        r1 = r10;
        if(r1 != 0x6 && (MEMORY.ref(4, r7 + 0x150).get() & 0x7) != 0) {
          MEMORY.ref(4, r7 + 0x150).incr();
        } else {
          //LAB_80bde94
          r5 = CPU.sp().value + 0xc;
          ...
          //LAB_80bdeb0
          for(r6 = 0; ; r6++) {
            final Sprite38 sprite = getActorSprite(getCombatantForUnit(MEMORY.ref(4, r7 + 0x164).get()).actor_00.deref(), r6);
            if(sprite == null) {
              break;
            }
        ...
        if(r3 == 0x4) {
          ...
          //LAB_80bdede
          if(r3 > 0x4) {
            final BattleStruct82c.Combatant2c combatant = getCombatantForUnit(MEMORY.ref(4, r7 + 0x164).get());
            combatant._2a.set(1);
            r5 = CPU.sp().value + 0xc;
            ...
            if(r1 > 0x7f) {
              ...
              //LAB_80bdf3e
              FUN_80b7e60(MEMORY.ref(4, r7 + 0x164).get());
              MEMORY.ref(4, r7 + 0x148).setu(2);
              MEMORY.ref(4, r7 + 0x150).setu(0);
            } else {
              //LAB_80bdf60
              if(r2 > 0) {
                r4 = 0x13;
  ...
  @Method(0x80be18c)
  public static int FUN_80be18c(int r0) {
    int r1;
    int r2;
    int r3;
    int r4;
  ...
  public static int FUN_80be378(final BattleStruct82c.Turn10 turn, final BattleStruct82c.Sub64 r1_0) {
    ...
    switch(turn._06.get()) {
      ...
      case 1:
        ...
        if(sp1c.pp_3a.get() < MEMORY.ref(1, r6 + 0x9).getUnsigned()) {
          r1_0._5c.set(2);
          r5 = 0x0;
        }
        ...
        if(r5 != 0) {
          ...
          r5 = 0x0;
          r1_0._5c.set(0);
          sp1c.pp_3a.sub(MEMORY.ref(1, r6 + 0x9).getUnsigned());
      ...
      case 4:
        ...
        FUN_8015120(r11, 4);
        r0 = getAbility_(r11);
        if((MEMORY.ref(1, r0 + 0x1).getUnsigned() & 0xf) == 0x6) {
          r0 = 0x8f1;
        } else {
          //LAB_80be9cc
          r0 = 0x8f0;
    ...
    if(r11 == 0x1) {
        ...
        if((r3 & 0xffff_ffffL) <= (r4 & 0xffff_ffffL)) {
          ...
          if(r11 == 0xb2) {
            ...
            for(r6 = 0; r6 < r1_0._01.get(); r6++) {
              r1_0._3a.get(r6).set(FUN_8077178(turn.unitId_00.get(), r1_0._02.get(r6).get(), MEMORY.ref(1, r7 + 0x2).getUnsigned(), MEMORY.ref(1, r7 + 0x3).getUnsigned(), 100));
            }
          }
        }
      }
      ...
      if(FUN_80772b8(MEMORY.ref(1, r7 + 0x3).getUnsigned()) != 0) {
        r1_0._58.or(0x10000);
      }
  ...
  public static void FUN_80bf678() {
    ...
    //LAB_80bf7de
    r3 = MEMORY.ref(4, 0x3001e74).get();
    FUN_80c0774(2, MEMORY.ref(2, r3 + 0x648).getUnsigned(), 0);
    r3 = 0x80c35bc;
    ...
    if(MEMORY.ref(1, r1).getUnsigned() == 0) {
      ...
      r3 = MEMORY.ref(4, CPU.sp().value + 0x8).get();
      if(MEMORY.ref(1, r3 + 0x50).getUnsigned() != 0) {
        MEMORY.ref(4, CPU.sp().value + 0xc).setu(2);
        r2 = CPU.sp().value + 0xc;
        MEMORY.ref(4, CPU.sp().value).setu(r2);
    ...
    if(sp04 != 0) {
      ...
      if(sp04 != 0) {
        ...
        if(sp08.affliction_131.get() != 0) {
          ...
          r5 = boardWramMallocHead_3001e50.offset(9 * 0x4).get();
          FUN_80bbabc(8, charId);
          FUN_80bbabc(0, charId);
          FUN_80bbabc(1, r7);
          FUN_80bbabc(4, 0x851);
